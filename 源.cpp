...
int main()
{
	vector<int> v1;
	vector<int> v2;
	v1.push_back(1);//1、num1=[1,3]num2=[2]
	v1.push_back(3);
	v2.push_back(2);

	/*v1.push_back(1);2、num1 = [1, 2]num2 = [3,4]
	v1.push_back(2);
	v2.push_back(3);
	v2.push_back(4);*/

	/*v1.push_back(0);3、num1 = [0, 0]num2 = [0,0]
	v1.push_back(0);
	v2.push_back(0);
	v2.push_back(0);*/

	//v2.push_back(1);4、num1 = [ ]num2 = [1]
	
	//v1.push_back(2);5、num1 = [ 2 ]num2 = []
